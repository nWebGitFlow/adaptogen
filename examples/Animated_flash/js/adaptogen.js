...
$(document).ready(function(){ 
   ...
   * @todo
   */
  var root_width_list = ['--eye-width', '--moon-width', '--stone1-width',  '--stone2-width', '--stone3-width'];
  var root_height_list = ['--eye-height', '--moon-height', '--stone1-height',  '--stone2-height', '--stone3-height'];
  var root_left_list = ['--eye-left', '--moon-left', '--stone1-left',  '--stone2-left', '--stone3-left'];
  var root_top_list = ['--eye-top', '--moon-top', '--stone1-top',  '--stone2-top', '--stone3-top'];
  var root_any_list = [];
